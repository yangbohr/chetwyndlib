...
class WorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post :create, work_order: { date: @work_order.date, equipment: @work_order.equipment, title: @work_order.title }
    end
  ...
  test "should update work_order" do
    patch :update, id: @work_order, work_order: { date: @work_order.date, equipment: @work_order.equipment, title: @work_order.title }
    assert_redirected_to work_order_path(assigns(:work_order))
  end
